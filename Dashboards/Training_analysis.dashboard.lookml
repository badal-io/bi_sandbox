...
- dashboard: training_analysis
  title: "Call Center Performance & Training Analysis"
  layout: newspaper
  ...
  - name: lob_filter
    ...
    field: synthetic_training_data.lob
  ...
  - name: department_filter
    ...
    ui_config:
      ...
      display: popover
    explore: synthetic_training_data
    field: synthetic_training_data.department
  ...
  - name: language_filter
    ...
    ui_config:
      ...
      display: inline
    explore: synthetic_training_data
    field: synthetic_training_data.language
  ...
  - name: agent_manager_filter
    ...
    ui_config:
      ...
      display: popover
    explore: synthetic_training_data
    field: synthetic_training_data.agent_manager
  ...
  - name: total_calls
    ...
    explore: synthetic_training_data
    type: single_value
    fields: [synthetic_training_data.count]
    listen:
      lob_filter: synthetic_training_data.lob
      department_filter: synthetic_training_data.department
      language_filter: synthetic_training_data.language
      agent_manager_filter: synthetic_training_data.agent_manager
    row: 0
    col: 0
    width: 4
    height: 3
  ...
  - name: avg_call_duration
    ...
    - category: measure
      ...
      based_on: synthetic_training_data.duration
      _kind_hint: measure
  ...
  - name: unique_training_modules
    ...
    - category: measure
      ...
      value_format:
      value_format_name:
      based_on: synthetic_training_data.training_topic
      _kind_hint: measure
  ...
  - name: training_module_comparison
    ...
    explore: synthetic_training_data
    type: looker_grid
    fields: [synthetic_training_data.training_topic, synthetic_training_data.count,
             synthetic_training_data.lob, synthetic_training_data.department,
    ...
    - category: measure
      ...
      value_format: '#,##0.00'
      value_format_name: __custom
      based_on: synthetic_training_data.training_duration
      _kind_hint: measure
    ...
    - category: measure
      ...
      value_format:
      value_format_name:
      based_on: synthetic_training_data.repeat_call
      _kind_hint: measure
      measure: repeat_calls
      type: count
      _type_hint: number
      filters:
        synthetic_training_data.repeat_call: 'Yes'
    - category: measure
      expression: ''
      label: Retention Calls
      value_format:
      value_format_name:
      based_on: synthetic_training_data.retention_call
      _kind_hint: measure
      measure: retention_calls
      type: count
      _type_hint: number
      filters:
        synthetic_training_data.retention_call: 'Yes'
    - category: measure
      expression: ''
      label: Sales Calls
      value_format:
      value_format_name:
      based_on: synthetic_training_data.sales_call
      _kind_hint: measure
      measure: sales_calls
      type: count
      _type_hint: number
      filters:
        synthetic_training_data.sales_call: 'Yes'
    sorts: [synthetic_training_data.count desc]
    limit: 500
  ...
  - name: high_frequency_modules
    ...
    series_colors:
      synthetic_training_data.count: "#1f78b4"
    value_labels: legend
    label_type: labPer
    inner_radius: 50
    listen:
  ...
  - name: low_frequency_modules
    ...
    sorts: [synthetic_training_data.count]
    limit: 15
    x_axis_gridlines: false
    y_axis_gridlines: true
    show_view_names: false
    ...
    series_colors:
      synthetic_training_data.count: "#e31a1c"
    value_labels: legend
    label_type: labPer
    inner_radius: 50
    listen:
  ...
  - name: primary_topic_distribution
    ...
    explore: synthetic_training_data
    type: looker_pie
    fields: [synthetic_training_data.primary_topic, synthetic_training_data.count]
    sorts: [synthetic_training_data.count desc]
    limit: 500
    value_labels: legend
    label_type: labPer
  ...
  - name: secondary_topic_distribution
    ...
    explore: synthetic_training_data
    type: looker_pie
    fields: [synthetic_training_data.secondary_topic, synthetic_training_data.count]
  ...
  - name: topic_mapping_to_training
    ...
    explore: synthetic_training_data
    type: looker_grid
    fields: [synthetic_training_data.primary_topic, synthetic_training_data.secondary_topic,
             synthetic_training_data.training_topic, synthetic_training_data.count,
  ...
  - name: training_impact_on_repeats
    ...
    explore: synthetic_training_data
    type: looker_column
    fields: [synthetic_training_data.training_topic, total_calls, repeat_call_count]
    dynamic_fields:
    - category: measure
      expression: ''
      label: Total Calls
      value_format:
      value_format_name:
      based_on: synthetic_training_data.count
      _kind_hint: measure
      measure: total_calls
      type: count
      _type_hint: number
    ...
    color_application:
      collection_id: legacy
      palette_id: legacy_categorical1
    y_axes: [{label: '', orientation: left, series: [{axisId: repeat_rate, id: repeat_rate,
  ...
  - name: training_impact_on_retention
    ...
    explore: synthetic_training_data
    type: looker_column
    fields: [synthetic_training_data.training_topic, total_calls, retention_call_count]
    dynamic_fields:
    - category: measure
      expression: ''
      label: Total Calls
  ...
  - name: training_impact_on_sales
    ...
    explore: synthetic_training_data
    type: looker_column
    fields: [synthetic_training_data.training_topic, total_calls, sales_call_count]
    dynamic_fields:
    - category: measure
      expression: ''
      label: Total Calls
  ...
  - name: calls_by_lob_department
    ...
    explore: synthetic_training_data
    type: looker_grid
    fields: [synthetic_training_data.lob, synthetic_training_data.department,
             synthetic_training_data.count, repeat_calls, retention_calls, sales_calls,
             avg_duration]
    pivots: []
    dynamic_fields:
    - category: measure
  ...
  - name: lob_heatmap
    ...
    explore: synthetic_training_data
    type: looker_grid
    fields: [synthetic_training_data.lob, synthetic_training_data.training_topic,
             synthetic_training_data.count]
    pivots: [synthetic_training_data.training_topic]

    sorts: [synthetic_training_data.count desc 0, synthetic_training_data.training_topic]
    limit: 500
    column_limit: 50
    show_view_names: false
    show_row_numbers: true
  ...
  - name: language_distribution
    ...
    explore: synthetic_training_data
    type: looker_pie
    fields: [synthetic_training_data.language, synthetic_training_data.count]
  ...
  - name: training_by_language
    ...
    type: looker_column
    fields: [synthetic_training_data.training_topic, synthetic_training_data.count,
             synthetic_training_data.language]
    pivots: [synthetic_training_data.language]

    sorts: [synthetic_training_data.count desc 0, synthetic_training_data.language]
    limit: 15
    column_limit: 50
    x_axis_gridlines: false
    y_axis_gridlines: true
    ...
    color_application:
      ...
      palette_id: legacy_categorical1
    series_colors:
      en-US - synthetic_training_data.count: "#1f78b4"
      Fr-fr - synthetic_training_data.count: "#e31a1c"
    listen:
      lob_filter: synthetic_training_data.lob
      department_filter: synthetic_training_data.department
      language_filter: synthetic_training_data.language
  ...
  - name: agent_performance_summary
    ...
    explore: synthetic_training_data
    type: looker_grid
    fields: [synthetic_training_data.agent_manager, synthetic_training_data.agent_name,
             synthetic_training_data.count, repeat_calls, retention_calls, sales_calls,
             avg_duration]
    dynamic_fields:
    - category: measure
    ...
    - category: measure
      ...
      _type_hint: number
    - category: table_calculation
      expression: "${repeat_calls}/${synthetic_training_data.count}"
      label: Repeat Rate
      value_format: '#,##0.0%'
      value_format_name: __custom
      _kind_hint: measure
  ...
  - name: call_trends_over_time
    ...
    explore: synthetic_training_data
    type: looker_line
    fields: [synthetic_training_data.coversation_date, synthetic_training_data.count,
             repeat_calls, retention_calls, sales_calls]
    dynamic_fields:
    - category: measure
      expression: ''
    ...
    sorts: [synthetic_training_data.coversation_date]
    limit: 500
    x_axis_gridlines: false
    y_axis_gridlines: true
    show_view_names: false
  ...
  - name: missing_training_coverage
    ...
    type: looker_grid
    fields: [synthetic_training_data.primary_topic, synthetic_training_data.secondary_topic,
             synthetic_training_data.count, training_modules_count]
    dynamic_fields:
    - category: measure
      expression: ''
  ...
  - name: inbound_vs_outbound
    ...
    explore: synthetic_training_data
    type: looker_pie
    fields: [synthetic_training_data.call_type, synthetic_training_data.count]
  ...
  - name: call_type_by_training
    ...
    type: looker_column
    fields: [synthetic_training_data.training_topic, synthetic_training_data.count,
             synthetic_training_data.call_type]
    pivots: [synthetic_training_data.call_type]

    sorts: [synthetic_training_data.count desc 0, synthetic_training_data.call_type]
    limit: 15
    column_limit: 50
    x_axis_gridlines: false
    y_axis_gridlines: true
    ...
    color_application:
      ...
      palette_id: legacy_categorical1
    series_colors:
      inbound - synthetic_training_data.count: "#1f78b4"
      outbound - synthetic_training_data.count: "#33a02c"
    listen:
      lob_filter: synthetic_training_data.lob
      department_filter: synthetic_training_data.department
      language_filter: synthetic_training_data.language
