- dashboard: training_analysis_dashboard2

  title: Training Analysis Dashboard2
  layout: newspaper
  ...
  - name: total_calls
    ...
    filters:
      synthetic_training_data_enhanced.coversation_date: "{{ date_filter._parameter_value }}"
    listen:
  ...
  - name: training_impact_on_repeats
    ...
    explore: synthetic_training_data_enhanced
    type: looker_column
    fields: [synthetic_training_data_enhanced.training_topic, total_calls, repeat_call_count, repeat_rate]
    dynamic_fields:
    - category: measure
      expression: ''
      label: Total Calls
  ...
  - name: training_impact_on_retention
    ...
    explore: synthetic_training_data_enhanced
    type: looker_column
    fields: [synthetic_training_data_enhanced.training_topic, total_calls, retention_call_count, retention_rate]
    dynamic_fields:
    - category: measure
      expression: ''
      label: Total Calls
  ...
  - name: training_impact_on_sales
    ...
    explore: synthetic_training_data_enhanced
    type: looker_column
    fields: [synthetic_training_data_enhanced.training_topic, total_calls, sales_call_count, sales_rate]
    dynamic_fields:
    - category: measure
      expression: ''
      label: Total Calls
